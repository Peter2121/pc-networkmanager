...
static nmcommand cmds[] =
{
    ...
    { nmscope::INTERFACE, nmcmd::IP4_ALIAS_ADD },
    { nmscope::INTERFACE, nmcmd::IP6_ALIAS_ADD },
    { nmscope::INTERFACE, nmcmd::IP4_ALIAS_REMOVE },
    { nmscope::INTERFACE, nmcmd::IP6_ALIAS_REMOVE },
